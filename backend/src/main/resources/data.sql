...
INSERT INTO tb_enrollment (user_id, offer_id, enronll_Moment, refound_Moment, available, only_Update) VALUES (1, 1, TIMESTAMP WITH TIME ZONE '2020-12-20T13:00:00Z', null, true, false);
INSERT INTO tb_enrollment (user_id, offer_id, enronll_Moment, refound_Moment, available, only_Update) VALUES (2, 1, TIMESTAMP WITH TIME ZONE '2020-12-21T13:00:00Z', null, true, false);

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 1 do cap 1', 1, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (1, 'Marial de apoio: ABC', 'https://www.youtube.com/watch?v=lvsfZUrOx6s');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 2 do cap 1', 2, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (2, 'Suporte para alunos', 'https://www.youtube.com/watch?v=lvsfZUrOx6s');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Aula 3 do cap 1', 3, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (3, 'Marial de apoio: ABC', 'https://www.youtube.com/watch?v=lvsfZUrOx6s');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Tarefa do cap 1', 4, 1);
INSERT INTO tb_task (id, description, question_Count, approval_Count, weight, duo_Date) VALUES (4, 'Fazer um trabalho', 5, 4, 1.0, TIMESTAMP WITH TIME ZONE '2020-11-27T11:00:00Z');

INSERT INTO tb_lessons_done (lesson_id, user_id, offer_id) VALUES (1, 1, 1);
INSERT INTO tb_lessons_done (lesson_id, user_id, offer_id) VALUES (2, 1, 1);

INSERT INTO tb_deliver (uri, moment, status, feedback, correct_Count, user_id, offer_id, lesson_id) VALUES ('https://github.com/MatheusDario/Ds-learn--Bootcamp', TIMESTAMP WITH TIME ZONE '2020-11-28T11:00:00Z', 1, 'Ficou muito bom!', 5, 1, 1, 4);
